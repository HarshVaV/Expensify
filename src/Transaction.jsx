...
export const Transaction = ({index,transData, deleteData, editData}) => {
  ...
  return (
    <div className={`${bgColor} grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-2 py-2  rounded-xl`}>
     <div className="text-gray-400 text-center">{displayDate(date)}</div>
     <div className={`${amountColorClass} font-bold text-center hidden md:block` }>{capitalize(type)}</div>
